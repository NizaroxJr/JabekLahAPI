package com.example.jabeklah.service;
...
import com.example.jabeklah.repository.AgentFileRepo;
...
public class AdminService {
    ...
    public Boolean createAgent(String nom, String prenom, String pieceIdentite,
        ...
        String content="<h1> Hello Agent "+ nom +" "+prenom+" and Welcome To jabeklah  application.</h1> </br>" +
